...
This folder contains the review plus two comparison scripts:

- `README.md`: this technical review, ML translation, baseline comparison, use-case discussion, and ablation conclusions.
